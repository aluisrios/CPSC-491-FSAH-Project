...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(event) {
        ...
        if (!isNaN(income) && income <= 217000) {
            ...
            messageDiv.innerHTML = 'You do not qualify for financial aid as your annual income is less than $217,000.';
        }

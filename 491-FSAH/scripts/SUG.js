document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(event) {
        ...
        if (!isNaN(income) && enrollmentStatus !== 'Less_Than_Half_time') { // Updated value here
            messageDiv.innerHTML = 'You qualify for the State University Grant.';
            ...
            messageDiv.innerHTML = 'You do not qualify for financial aid with the State University Grant.';
        }
